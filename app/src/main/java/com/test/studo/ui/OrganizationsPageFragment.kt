...
class OrganizationsPageFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        view.create_organization_fab.setOnClickListener{
    ...
    private fun getAllOrganizations(organizationsPageFragment: OrganizationsPageFragment, swipeRefreshLayout: SwipeRefreshLayout){
